use super::*;
use crate::{executor::StatusType, fuzz_type::FuzzType};
...
impl LocalStats {
    pub fn register(&mut self, fuzz_type: FuzzType) {
        assert!(fuzz_type != FuzzType::Default);
    ...
    pub fn clear(&mut self) {
        ...
        self.num_edges = Default::default();
        self.num_branches = Default::default();
