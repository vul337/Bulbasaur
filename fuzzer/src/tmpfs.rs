...
pub fn create_tmpfs_dir(target: &Path) {
    ...
    /*
        Based on experimental data, using /dev/shm as the directory does not significantly improve fuzzing performance.
        To keep things simple, it has been disabled.
     */
