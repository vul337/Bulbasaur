...
#define STRCMP_MAX_LEN 127
#define STRCMP_TRACE_MAX_LEN 32
#define STRCMP_MAX_CNT 64

#define FRONTIER_BRANCH_SHM_VAR "FRONTIER_SHM_ID" // __frontier_branch_map_ptr
#define PARAFUZZ_FORKSRV_FD_VAR  "PARAFUZZ_FORKSRV_FD"  // forksrv_fd